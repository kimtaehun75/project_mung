	...
	<div class="card shadow mb-4" style="float: center;">
		<div class="card-body">
			...
			<div class="form-group">
				작성자<input class="form-control" name="writer" value="${after.userid}"
					readonly="readonly" style="width: 30%;" />
			</div>
			<div class="form-group">
				제목<input class="form-control" name="title" value="${after.title}"
			...
			<div>
				...
				<sec:authorize access="isAuthenticated()">
					...
					<c:if test="${pinfo.username eq after.userid }">
		        ...
		        <sec:authorize access="isAuthenticated()">
		           <button id="addReportBtn" class="btn btn-danger btn-xs">신고</button>
		        </sec:authorize>
			</div>
               ...
               <div class="modal-dialog">
               	<div class="modal-content">
	               	...
	               	<div class="modal-body">
		               	<div class="form-group">
			               	<label>대상</label>
			               	<input class="form-control" name=rpuser value="${after.userid}" readonly>
		               	</div>
		               	<div class="form-group">
			               	<label>작성자</label>
...
<script>
	...
	/* replyService.update({
		...
		$(document).ready(function(){
			var bnoValue = '<c:out value="${after.bno}"/>';
			...
			var rpuser = '<c:out value="${after.userid}"/>';
			var userid=null;
			<sec:authorize access="isAuthenticated()">
...
<script>
	...
	$(document).ready(function() {
		...
		$("button[data-oper='list']").on("click", function(e) {
			...
			operForm.attr("action", "/freeboard/freeboard");
			operForm.submit();
		});

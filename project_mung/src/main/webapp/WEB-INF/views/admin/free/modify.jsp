...
<script type="text/javascript">
	...
	<div>
		<form action="/admin/free/freeModify" method="post" role="form">
			<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
			<input type="hidden" id="" name="userid" value="${free.userid}"/>
				...
				<td>
					<div class="form-group">
						...
						<input class="form-control" type="text" id="" name="title"
							style="width: 100%;" value="${free.title }" required/>
					</div>
				</td>
			</tr>
			<tr>
				<td><label for="">게시글 내용</label>
					...
					<div class="form-group">
						<textarea name="content" id="editor" 
							style="width: 100%; height: 500px;">${free.content }</textarea>							
					</div>
				</td>
			</tr>
			<tr>

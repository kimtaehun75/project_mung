...
<div class="page-wrapper">
	...
	<div>
		<div>
			<div>
				...
				<div align="right">
					<a href="../faq/addFaq"><button id="addFaq"
							style="color: green;">faq 등록</button></a>
				</div>
			</div>
		</div>
		<table id="faqTable" width="100%" cellspacing="0">
			<thead>
				<tr align="center">
					<th style="width: 10%">FAQ 번호</th>
					<th style="width: 90%">FAQ 제목</th>
				</tr>
			</thead>
			<c:forEach items="${faq}" var="faq" varStatus="i">
				<tbody>
					<tr align="center">
						<td style="width: 10%">${faq.bno}</td>
						<td style="width: 90%"><a href="./faqInfo?bno=${faq.bno}" class="">${faq.title}</a>
						</td>
					</tr>
				</tbody>
			</c:forEach>
	...
	<form id="actionForm" action="/admin/faq/faq" method="get">

    		...
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="images/product-1.jpg" class="image-popup">
    					<img src="http://localhost:8090/resources/images/${sale.attachImage.imagePath}/${sale.attachImage.uuid}_${sale.attachImage.fileName}" class="img-fluid" alt="Colorlib Template">
    				</a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				<h3>${sale.saleName }</h3>
    				<p class="price"><span>${sale.cost }</span></p>
    				<p>
					${sale.content}
					</p>
...
<!-- 다른 페이지들 끝 -->
	<form id="actionForm" action="/sale/detail" method="get">

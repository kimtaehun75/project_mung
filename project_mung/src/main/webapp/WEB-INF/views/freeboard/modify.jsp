    ...
    $(function(){
        ...
        nhn.husky.EZCreator.createInIFrame({
            ...
            fOnAppLoad : function(){
            	...
            	obj.getById["editor"].exec("PASTE_HTML",['${board.content}']);
...
<div>
	<form action="/freeboard/modify" method="post" role="form">
		<table style="width: 60%; margin: auto;">
			<tr>
				<td>
					<div class="form-group">
						제목 <input class="form-control" type="text" id="" name="title" value="${board.title}"
							style="width: 100%;" />
					</div>
				</td>
			</tr>
			<tr>
				<td><label for="">내용</label>
